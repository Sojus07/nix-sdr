...
class grgsm_livemon(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, args="", collector="localhost", collectorport='4729', fc=925.8e6, gain=30, osr=4, ppm=0, samp_rate=2000000.052982, serverport='4729', shiftoff=400e3):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "grgsm_livemon")
        ...
        self._ppm_slider_range = qtgui.Range(-150, 150, 0.1, ppm, 100)
        self._ppm_slider_win = qtgui.RangeWidget(self._ppm_slider_range, self.set_ppm_slider, "PPM Offset", "counter", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._ppm_slider_win)
        self._gain_slider_range = qtgui.Range(0, 100, 0.5, gain, 100)
        self._gain_slider_win = qtgui.RangeWidget(self._gain_slider_range, self.set_gain_slider, "Gain", "counter", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._gain_slider_win)
        self._fc_slider_range = qtgui.Range(800e6, 1990e6, 2e5, fc, 100)
        self._fc_slider_win = qtgui.RangeWidget(self._fc_slider_range, self.set_fc_slider, "Frequency", "counter_slider", float, QtCore.Qt.Horizontal)
